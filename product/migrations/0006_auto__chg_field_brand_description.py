...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('product_brand', 'description', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'Brand.description'
        db.alter_column('product_brand', 'description', self.gf('django.db.models.fields.TextField')())
