...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.discount_id'
        db.add_column('product_product', 'discount_id',
    ...
    def backwards(self, orm):
        ...
        db.add_column('product_product', 'discount',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='products', null=True, to=orm['discount.Discount'], blank=True),
                      keep_default=False)

        # Deleting field 'Product.discount_id'
        db.delete_column('product_product', 'discount_id')
    ...
    models = {
        ...
        'product.product': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'discount_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
