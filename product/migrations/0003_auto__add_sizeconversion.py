...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SizeConversion'
        db.create_table('product_sizeconversion', (
        ...
        db.send_create_signal('product', ['SizeConversion'])


    def backwards(self, orm):
        # Deleting model 'SizeConversion'
        db.delete_table('product_sizeconversion')
