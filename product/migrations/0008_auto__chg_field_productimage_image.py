...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('product_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ProductImage.image'
        db.alter_column('product_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
