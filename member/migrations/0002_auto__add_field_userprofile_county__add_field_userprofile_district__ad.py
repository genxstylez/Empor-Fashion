...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.county'
        db.add_column('member_userprofile', 'county',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'UserProfile.district'
        db.add_column('member_userprofile', 'district',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'UserTemp.county'
        db.add_column('member_usertemp', 'county',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'UserTemp.district'
        db.add_column('member_usertemp', 'district',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.county'
        db.delete_column('member_userprofile', 'county')

        # Deleting field 'UserProfile.district'
        db.delete_column('member_userprofile', 'district')

        # Deleting field 'UserTemp.county'
        db.delete_column('member_usertemp', 'county')

        # Deleting field 'UserTemp.district'
        db.delete_column('member_usertemp', 'district')
    ...
    models = {
        ...
        'member.userprofile': {
            ...
            'county': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
